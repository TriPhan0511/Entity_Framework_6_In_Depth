...
namespace Vidzy_DIY
{
    ...
    public partial class VidzyDbContext : DbContext
    {
        ...
        public virtual ObjectResult<GetVideosResult> GetVideos()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetVideosResult>("GetVideos");
        }
    
        public virtual int DeleteAllVideos()
        {
